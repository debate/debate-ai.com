...
import roundsPolicy from "debate-data-sync/data/videos/rounds-policy.json";
import roundsPf from "debate-data-sync/data/videos/rounds-pf.json";
import roundsLd from "debate-data-sync/data/videos/rounds-ld.json";
import roundsCollege from "debate-data-sync/data/videos/rounds-college.json";
import topPicks from "debate-data-sync/data/videos/debate-top-picks.json";
import lectures from "debate-data-sync/data/videos/debate-lectures.json";
