...
import { LogIn, LogOut, UserCircle2, Moon, Sun, Palette, Pause, Play, Trophy, Inbox, Award, Library, NotebookPen, History, Gavel, Users, Dumbbell, ClipboardList, GraduationCap, Scale, FileText, Swords, MessageSquareText, Type, ListTree, Bot, Lightbulb, PlayCircle, TrendingUp, BarChart3, Users2, School, FolderTree, ThumbsUp, Medal, Target, BookOpen, PieChart, Presentation, ListChecks, Flame, CheckSquare, Landmark, MapPin, Sparkles, Bell, Compass, LayoutGrid } from "lucide-react"
...
function SettingsMenu({ side, onSignIn }: { side: "bottom" | "top"; onSignIn: () => void }) {
  ...
  return (
    <DropdownMenuContent side={side} align="end" className="w-48">
      {/* First item: this menu is a flat list of forty-odd destinations, so
          the page that actually explains them belongs above it. */}
