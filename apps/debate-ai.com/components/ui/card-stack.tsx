        ...
        >
          <AnimatePresence initial={false}>
            {items.map((item, i) => {
              ...
              // If hovered but not active, bring forward slightly
              const scale = isActive ? activeScale : isHovered ? 1.0 : inactiveScale;
              const lift = isActive ? -activeLiftPx : isHovered ? -activeLiftPx * 0.5 : 0;

              const rotateX = isActive ? 0 : isHovered ? tiltXDeg * 0.5 : tiltXDeg;

              // Boost z-index for hovered card
              const zIndex = isHovered && !isActive ? 150 : 100 - abs;
