...
import { scrapeDivision, getDatasets } from "@/lib/third-party-sync/sync-debate-leaderboard"
...
export async function GET(request: Request) {
  ...
  console.log("[v0] Leaderboard API called with year:", year, "division:", division)
