...
export type { EditorProps, ToolbarCustomization } from './lexical/index';

// Toolbar customization helpers
export { TOOLBAR_ITEM_IDS } from './lexical/plugins/ToolbarPlugin';
export type { ToolbarItemId } from './lexical/plugins/ToolbarPlugin';
