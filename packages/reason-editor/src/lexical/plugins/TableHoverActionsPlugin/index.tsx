/**
 * @fileoverview Plugin that provides floating action buttons (buttons to add rows/columns)
 * when hovering over the last row or column of a table.
 */
...
/**
 * Container component that manages the positioning and visibility of table hover action buttons.
 */
...
/**
 * Plugin that renders a portal-based UI for adding rows and columns via hover actions.
 * @param {Object} props - Component props.
 * @param {HTMLElement} [props.anchorElem=document.body] - The element to anchor the hover UI to.
 * @returns {React.ReactPortal | null} The rendered table hover actions plugin.
 */
