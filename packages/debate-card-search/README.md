...
```tsx
import { SearchInterface, ContributionLeaderboardPanel, TaskInboxPanel, ProgressUnlocksPanel, EvidenceLibraryPanel } from "debate-card-search"
```
...
│   │                 # ProgressUnlocksPanel, EvidenceLibraryPanel)
