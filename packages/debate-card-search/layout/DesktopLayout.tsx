...
import { ResizablePanelGroup, ResizablePanel, ResizableHandle } from "debate-ui/resizable"
import { ResearchSearchSidebar, type SearchFilters } from "../ResearchSearchSidebar"
  ...
  return (
    <div className="flex-1 hidden md:block overflow-hidden">
      <ResizablePanelGroup orientation="horizontal" className="h-full">
        ...
        {/* Center panel: card content viewer */}
        <ResizablePanel maxSize={80} minSize={20} defaultSize={isAiAnalysisSidebarCollapsed ? 80 : 50}>
          <CardContentViewer
