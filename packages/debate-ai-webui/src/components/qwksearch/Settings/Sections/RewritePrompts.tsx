...
interface RewritePromptsProps {
  fields: any;
  values: any;
}

type TabType = 'prompts' | 'editor';

const RewritePrompts = ({ fields, values }: RewritePromptsProps) => {
    ...
    return (
      <div className="px-6 py-4">
        <p className="text-sm text-black/50 dark:text-white/50">
          No rewrite prompt settings available.
        </p>
      </div>
    );
  }
