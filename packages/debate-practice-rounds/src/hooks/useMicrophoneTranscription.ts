/**
 * @fileoverview React wiring for `round/microphone-transcription.ts` — see
 * that module's file doc for the idea #6 ("Speech Transcript Summaries and
 * Answers") follow-up this closes.
 *
...
} from "../round/microphone-transcription"
