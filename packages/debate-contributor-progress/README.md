...
<p align="center">
    ...
    <a href="https://stackblitz.com/github/debate/debate-ai.com/tree/master/packages/debate-contributor-progress"><img height="20px" src="https://developer.stackblitz.com/img/open_in_stackblitz.svg" alt="Open in StackBlitz" /></a>
    <br />
...
Current Codecov package coverage on `master` at commit `50322f5` is **45.51%** (tracked
under the `debate-contributor-progress` flag).
