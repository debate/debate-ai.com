...
} from "../src/coach/microphone-transcription";
...
describe("appendDictatedSegment", () => {
  ...
  it("joins existing text and a new segment with a single space", () => {
    expect(appendDictatedSegment("Today we cover topicality.", "Then we cover theory.")).toBe(
      "Today we cover topicality. Then we cover theory.",
    );
  });
  ...
  it("is a no-op when the new segment is empty or whitespace-only", () => {
    expect(appendDictatedSegment("Today we cover topicality.", "   ")).toBe(
      "Today we cover topicality.",
    );
    expect(appendDictatedSegment("Today we cover topicality.", "")).toBe(
      "Today we cover topicality.",
    );
