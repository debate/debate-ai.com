import type { TextBlock,  TokenStyle, TextToken } from './tokens';
...
// htmlparser2 is the fastest, 5x faster than parse5 in jsdom cheerio
// https://github.com/fb55/htmlparser2#performance 
