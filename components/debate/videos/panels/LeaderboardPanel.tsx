...
export function LeaderboardPanel() {
  ...
  const [division, setDivision] = useState<Division>("VPF")
          ...
          <div className="max-w-[1600px] mx-auto">
            ...
            {!championsLoading && (
              <div className="mb-4 flex items-center gap-4 rounded-lg border bg-card p-4">
                <article
                  className="w-[120px] h-[120px] sm:w-[250px] sm:h-[250px] shrink-0 rounded-lg overflow-hidden will-change-transform"
                  onMouseMove={(e) => {
            ...
            {division === "NDT" ? (
              !championsLoading && !topic && !champion ? (
                <div className="flex flex-col items-center justify-center min-h-[400px] text-center">
                  <p className="text-muted-foreground">
                    College NDT data for {year} is not available yet.
                  </p>
                </div>
              ) : championsLoading ? (
              ...
              <>
                {loading ? (
                  ...
                  <div className="flex flex-col items-center justify-center min-h-[400px] text-center">
                    <p className="text-muted-foreground">
                      Leaderboard data for {divConfig.label} in {year} is not available yet.
                    </p>
                  </div>
                ) : (
