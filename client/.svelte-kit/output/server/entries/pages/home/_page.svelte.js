import { c as create_ssr_component, e as escape, d as add_attribute, a as validate_store, b as subscribe, f as each, v as validate_component } from "../../../chunks/index2.js";
import { c as currentUser, g as getImageURL, p as pb } from "../../../chunks/pocketbase.js";
...
const Page = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  $$unsubscribe_currentUser();
  return `<div class="flex justify-between mt-8 space-x-8 px-8 w-full"><div class="flex-1 max-w-md"><div class="bg-[#2e2e2e] rounded-md drop-shadow-md text-white p-5"><div class="flex justify-between mb-6 items-center"><p class="text-neutral-300">People you may know</p>
	...
	<div class="flex-1 text-white max-w-md"><div class=""><div class="flex justify-between items-center mb-4"><h3 class="font-semibold text-neutral-300">Following</h3>
